...
$("#hexBox").change(hexBoxChanged);
$("#redBox").change(redBoxChanged);
$("#greenBox").change(greenBoxChanged);
$("#blueBox").change(blueBoxChanged);
$("#hueBox").change(hueBoxChanged);
$("#saturationBox").change(saturationBoxChanged);
$("#valueBox").change(valueBoxChanged);
