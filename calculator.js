$(function(){
  ...
  $(".close").click(function(){
					...
					$(".hoNon").html('<p>Ho non! :o Vous avez quitter la calculatrice :(  Rafraichisser la page pour la faire apparaitre :)</p><button class="button" id="refresh-calc">Rafraichir</button>');
					})
  })

$('#refresh-calc').click(function() {
    location.reload();
});